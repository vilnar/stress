...
func (this *apiopts) init(opts getopt.Set) {
...
func (this *apiplug) setup(opts interface{}) {

	a := opts.(*apiplug)

	this.apiopts = a.apiopts
	var err error
...
func (this *apiplug) query(queries *[]string) []queryInfo {
	...
	for _, query := range *queries {
		...
		start := time.Now()
		count, msg, err := this.client.SendServerSearch(this.idx, query, this.maxmatches)
